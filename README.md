...
### Occasional Layout Shift on Mobile Microphone Button

**Issue:** Very occasional layout shift occurs when users click the microphone button to start recording on mobile devices.
